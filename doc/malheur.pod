...
B<malheur> [B<-hrvV>] [B<-m> I<maldir>] [B<-o> I<outfile>] [B<-d> I<dumpfile>] I<action> I<dataset>
...
If this option is set, B<malheur> dumps the extracted feature vectors to
I<dumpfile> in libsvm format.  Note that the output is not fully compatible
