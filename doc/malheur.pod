...
written to the internal state in <statedir> for further incremental
...
The configuration of harry is provided by a configuration file.  This file
...
=item B<output_file = "m-output.txt";>
